...
\vspace{-1pt}
\begin{minipage}[t]{0.38\textwidth-.5\columnsep}
    \begin{dsaSheetBox}
...
\end{minipage}%
\hfill
\begin{minipage}[t]{0.24\textwidth-.5\columnsep}
    \begin{dsaSheetBox}
        \begin{tabular}{p{\dimexpr\textwidth-2\tabcolsep}}
            \directlua{common.multiline_content({name=" ", rows=10, baselinestretch=1.35})}
        \end{tabular}
    \end{dsaSheetBox}%
\end{minipage}%
\hfill
