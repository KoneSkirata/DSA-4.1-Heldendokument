...
#        sha256 = "7dad01f12a526bca74ed4235a307f5bfe7939f5bc66b738cd6709f5aa5e3c7bd";
        url = https://www.ulisses-spiele.de/assets/download/dasschwarze_auge_fanpaket.zip;
        sha256 = "08nixn1n9ql79127w7638pd7705205pj084i5jp4gm4rh99s5qzf";
      };
      wds = pkgs.fetchurl {
#        url = http://www.ulisses-spiele.de/download/468/;
#        sha256 = "273dc1e19b5dc95c2454c7f2cfd8b49688f11312e6b82cd8f3bc63ee13b371a4";
        url = https://ulisses-spiele.de/assets/document/0A/Wege-des-Schwerts_Handouts_fee3.pdf;
        sha256 = "193inc9ywqxwygc2rf76289z324nnkcczwn7ahj5rjaxkghw2g97";
      };
      ...
      packages = with pkgs; rec {
        ...
        dsa41held = stdenvNoCC.mkDerivation rec {
          ...
          installPhase = ''
            ...
            ${unzip}/bin/unzip -p "${fanpaket}" "Das Schwarze Auge - Fanpaket - 2013.06.28/Logo - Fanprodukt.png" >"$out/share/img/logo-fanprodukt.png"
